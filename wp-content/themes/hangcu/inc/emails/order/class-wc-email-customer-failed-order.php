...
if ( ! class_exists( 'WC_Email_Customer_Failed_Order', false ) ) :
	 ...
	 * Failed Order Email.
	 *
	 * An email sent to the admin when an order is failed.
	 *
	...
	class WC_Email_Customer_Failed_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Đơn hàng không thành công', 'hangcu' );
			$this->description    = __( 'Email này sẽ được gửi đi khi đơn hàng của khách có trạng thái thất bại', 'hangcu' );
			$this->template_html  = 'emails/customer-failed-order.php';
			$this->template_plain = 'emails/customer-failed-order.php';
			...
			// add_action( 'woocommerce_order_status_pendingcancel_to_failed', array( $this, 'trigger' ), 10, 2 );
		...
		public function get_default_subject() {
			return __( '[{site_title}]: Đơn hàng #{order_number} không thành công', 'hangcu' );
		}
		...
		public function get_default_heading() {
			return __( 'Đơn hàng: #{order_number} không thành công', 'hangcu' );
		}
