...
<div id="payment" class="woocommerce-checkout-payment">
	...
	<div class="form-row place-order">
		...
		<?php 
			do_action('hangcu_custom_template_checkout_payment');
		...
		<?php if( wp_is_mobile() ) : ?>
			<div class="process-checkout">
				<div class="order-total">
					...
					<strong data-title="<?php esc_attr_e( 'Thành tiền', 'hangcu' ); ?>"><?php wc_cart_totals_order_total_html(); ?></strong>
				</div>
				<?php 
					echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="button alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( __('Thanh toán đơn hàng', 'hangcu') ) . '" data-value="' . esc_attr( __('Thanh toán đơn hàng', 'hangcu') ) . '">' . esc_html( __('Thanh toán đơn hàng', 'hangcu') ) . '</button>' ); // @codingStandardsIgnoreLine
				?>
			</div>
		<?php else :
