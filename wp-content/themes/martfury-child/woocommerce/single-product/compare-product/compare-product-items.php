...
if ($productIds && count($productIds) > 0) { ?>
    ...
    <div class="compare-products" id="compare-products">
        <div class="col-12">
            <div class="row">
                <h4 class="title-compare"><?php echo __('So sánh với các sản phẩm tương tự', 'compare-product') ?></h4>
                ...
                <div class="search-product-compare">
                    <div class="input-group">
                        <input type="text" class="form-control" name="input-product-compare" id="input-product-compare"
                            placeholder="<?php echo __('Nhập tên sản phẩm muốn so sánh', 'compare-product') ?>" 
                            aria-label="<?php echo __('Nhập tên sản phẩm muốn so sánh', 'compare-product') ?>" aria-describedby="basic-addon2">
