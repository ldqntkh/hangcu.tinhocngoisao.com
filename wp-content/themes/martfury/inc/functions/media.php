...
add_filter( 'kirki/enqueue_google_fonts', 'marfury_default_font_kirki' );

function marfury_default_font_kirki($args) {
	if( ! intval(martfury_get_option( 'googlefont_kirki' )) ) {
		return array();
	}
