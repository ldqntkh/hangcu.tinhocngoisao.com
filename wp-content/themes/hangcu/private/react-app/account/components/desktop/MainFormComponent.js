...

                {
                    ...
                    <div className="popup-navbar-account minimum">
                        ...
                        {/* {
                                ...
                                <aside id="login-facebook">
                                    <SocialButton
                                        ...
                                        <a href="#" 
                                            ...
                                            <img src="/wp-content/themes/hangcu-electro-child-v1/assets/images/facebook.png" />
                            ...
                            :
                            <aside id="login-facebook">
                                <div className="nsl-container nsl-container-block" data-align="left">
                                    <a href={`${login_account_url}?loginSocial=facebook&amp;redirect=${home_page}`} 
                                        rel="nofollow" aria-label="Đăng nhập với <b>Facebook</b>" 
                                        data-plugin="nsl" data-action="connect" 
                                        data-provider="facebook" data-popupwidth="475" 
                                        data-popupheight="175"
                        ...
                        {/* {
                                ...
                                <aside id="login-google">
                                    ...
                                    >
                                            <a href={`#`}  rel="nofollow" 
                                                ...
                                                <img src="/wp-content/themes/hangcu-electro-child-v1/assets/images/google.png" />
                            ...
                            <aside id="login-google">
                                <div className="nsl-container nsl-container-block" data-align="left">
                                    <a href={`${login_account_url}?loginSocial=google&amp;redirect=${home_page}`}  rel="nofollow" 
                                        aria-label="Đăng nhập với <b>Google</b>" 
                                        data-plugin="nsl" data-action="connect" 
                                        data-provider="google" data-popupwidth="600" data-popupheight="600"
                                        className="btn-google">
                        ...
                        {/* <aside id="login-google">
                            <div className="nsl-container nsl-container-block" data-align="left">
                                <a href={`${login_account_url}?loginSocial=google&amp;redirect=${home_page}/?t=_${new Date().getTime()}`}  rel="nofollow" 
                                    aria-label="Đăng nhập với <b>Google</b>" 
                                    data-plugin="nsl" data-action="connect" 
                                    data-provider="google" data-popupwidth="600" data-popupheight="600"
                                    className="btn-google">
