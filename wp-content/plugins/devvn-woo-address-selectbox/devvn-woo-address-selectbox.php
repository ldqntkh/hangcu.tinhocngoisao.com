        ...
        function get_address_by_phonenumber()
        {
            ...
            <div class="get_address_byphone_wrap">
                <button class="get_address_byphone" type="button"
                        data-mfp-src="#get_address_content"><?php _e('+ Get address by number phone', 'devvn-vncheckout') ?></button>
                <div id="get_address_content" class="mfp-hide">
                    <div class="get_address_content_input">
                        <input name="sdt_get_address" id="sdt_get_address"
                               placeholder="<?php _e('Type your phone number', 'devvn-vncheckout') ?>"/>
                    </div>
                    <?php if ($this->enable_recaptcha()) : ?>
                        <div class="g-recaptcha"
                             data-sitekey="<?php echo $this->get_options('recaptcha_sitekey'); ?>"></div>
                    <?php endif; ?>
